...
class AddressTest extends TestCase
{
    ...
    public function testDeleteSuccess(): void {
        ...
        $address = Address::query()->first();
        $this->delete("/api/contacts/$address->contact_id/addresses/$address->id", headers: ["Authorization" => "test"])
            ->assertStatus(200)
            ->assertJson([
                "data" => true
            ]);
    ...
    public function testDeleteNotFound(): void {
        ...
        $address = Address::query()->first();
        $this->delete("/api/contacts/$address->contact_id/addresses/".($address->id+1), headers: ["Authorization" => "test"])
            ->assertStatus(404)
            ->assertJson([
                "errors" => [
                    "message" => ["Not found"]
    ...
    public function testListSuccess(): void {
        ...
        $this->get("/api/contacts/$contact->id/addresses", headers: ["Authorization" => "test"])
            ->assertStatus(200)
            ->assertJson([
                "data" => [
                    [
    ...
    public function testListContactNotFound(): void {
        ...
        $this->get("/api/contacts/".($contact->id+1)."/addresses", headers: ["Authorization" => "test"])
            ->assertStatus(404)
            ->assertJson([
                "errors" => [
                    "message" => ["Not found"]
